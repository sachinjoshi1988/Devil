...
/**
 * Coordinates bounded constitutional World Model update evaluation after an
 * outcome has been established.
 *
 * This authority does not mutate world state, claim that world state changed,
 * change task or plan state, create memory or learning, communicate
 * externally, or absorb the responsibilities of earlier constitutional
 * authorities.
 */
interface WorldModelUpdateAuthority {
