...
/**
 * Coordinates bounded constitutional observation after execution evaluation.
 *
 * This authority does not activate capabilities, invoke platform APIs, perform
 * actions, fabricate execution attempts, invent observation evidence, verify
 * outcomes, update world state, report success, or produce final outcomes.
 */
