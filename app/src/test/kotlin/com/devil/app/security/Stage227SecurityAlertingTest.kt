...
class Stage227SecurityAlertingTest {

    @Test
    fun `understood Stage 226 event produces available alert with exact provenance`() {
        val eventUnderstanding =
            understoodEvent()
        ...
        val result =
            AndroidSecurityAlertingCoordinator()
                .prepare(
                    ...
                    alertDescription =
                        "  Motion event requires owner attention.  ",
                )
        ...
        assertSame(
            eventUnderstanding.signal,
            result.eventUnderstanding.signal,
        )
        assertEquals(
            "Motion event requires owner attention.",
    ...
    @Test
    fun `blank alert description keeps Stage 227 deferred`() {
        val eventUnderstanding =
            understoodEvent()
    ...
    @Test
    fun `deferred Stage 226 event keeps Stage 227 deferred`() {
        val eventUnderstanding =
            deferredEvent()
    ...
    @Test
    fun `available result requires understood Stage 226 event`() {
        val eventUnderstanding =
            deferredEvent()
    ...
    @Test
    fun `available result preserves exact Stage 226 object provenance`() {
        val eventUnderstanding =
            understoodEvent()
    ...
    @Test
    fun `available result rejects blank alert description`() {
        val eventUnderstanding =
            understoodEvent()
    ...
    @Test
    fun `deferred result cannot smuggle alert metadata`() {
        val eventUnderstanding =
            understoodEvent()
